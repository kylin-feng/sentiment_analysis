...
#分类卷积神经网络训练
#我多心了，这玩意就是个库
def simple_CNN(input_shape, num_classes):#简易cnn
...
def simpler_CNN(input_shape, num_classes):#更加简易的cnn
...
def tiny_XCEPTION(input_shape, num_classes, l2_regularization=0.01):#深度可分离卷积块 xception 模型
...
def mini_XCEPTION(input_shape, num_classes, l2_regularization=0.01):#小型xception模型
    regularization = l2(l2_regularization)
...
def big_XCEPTION(input_shape, num_classes):#大型xception模型
    img_input = Input(input_shape)
...
#感觉用的都是那种统计学里，前两章出现的算法，，像贝叶斯那种简易但是有效的算法，，
